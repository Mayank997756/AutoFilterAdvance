...
BOT_TOKEN = environ.get('BOT_TOKEN', "6350178848:AAHUPESINa9XGP37dNhlKQIpBX-2i5HGudc")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002020322895').split()]
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1001894286532)
